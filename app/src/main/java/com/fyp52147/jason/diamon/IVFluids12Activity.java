...
public class IVFluids12Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ivfluids12);
        ...
        mAuthListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                {
                    startActivity(new Intent(IVFluids12Activity.this, LoginActivity.class));
                }
            }
        };
    ...
    private void searchBaby() {
        ...
        mBaby.child(babyName).child("ivfluids12").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(map.get("d1r1v12")!=null){
                        mbgl1 = map.get("d1r1v12").toString();
                        editTextR1.setText(mbgl1);
                    }
                    if(map.get("d1r2v12")!=null){
                        mbgl2 = map.get("d1r2v12").toString();
                        editTextR2.setText(mbgl2);
                    }
                    if(map.get("d1r3v12")!=null){
                        mbgl3 = map.get("d1r3v12").toString();
                        editTextR3.setText(mbgl3);
                    }
                    if(map.get("d1r4v12")!=null){
                        mbgl4 = map.get("d1r4v12").toString();
                        editTextR4.setText(mbgl4);
                    }
                    if(map.get("d1r5v12")!=null){
                        mbgl5 = map.get("d1r5v12").toString();
                        editTextR5.setText(mbgl5);
                    }
                    if(map.get("d1r6v12")!=null){
                        mbgl6 = map.get("d1r6v12").toString();
                        editTextR6.setText(mbgl6);
                    }
                    if(map.get("d1r7v12")!=null){
                        mbgl7 = map.get("d1r7v12").toString();
                        editTextR7.setText(mbgl7);
                    }
                    if(map.get("d1r8v12")!=null){
                        mbgl8 = map.get("d1r8v12").toString();
                        editTextR8.setText(mbgl8);
                    }
                    if(map.get("d1r9v12")!=null){
                        mbgl9 = map.get("d1r9v12").toString();
                        editTextR9.setText(mbgl9);
                    }
                    if(map.get("d1r10v12")!=null){
                        mbgl10 = map.get("d1r10v12").toString();
                        editTextR10.setText(mbgl10);
                    }
                    if(map.get("d1r11v12")!=null){
                        mbgl11 = map.get("d1r11v12").toString();
    ...
    private void saveData() {
        ...
        babyMap.put("d1r1v12", mbgl1);
        babyMap.put("d1r2v12", mbgl2);
        babyMap.put("d1r3v12", mbgl3);
        babyMap.put("d1r4v12", mbgl4);
        babyMap.put("d1r5v12", mbgl5);
        babyMap.put("d1r6v12", mbgl6);
        babyMap.put("d1r7v12", mbgl7);
        babyMap.put("d1r8v12", mbgl8);
        babyMap.put("d1r9v12", mbgl9);
        babyMap.put("d1r10v12", mbgl10);
        babyMap.put("d1r11v12", mbgl11);


        mBaby.child(babyName).child("ivfluids12").updateChildren(babyMap).addOnCompleteListener(new OnCompleteListener() {
            @Override
            public void onComplete(@NonNull Task task) {
                if(task.isSuccessful())
                {
                    if (((bgl1<2.5)&&(bgl1!=0)) || ((bgl2 <2.5)&&(bgl2!=0)) || ((bgl3 <2.5)&&(bgl3!=0)) || ((bgl4 <2.5)&&(bgl4!=0)) || ((bgl5 <2.5)&&(bgl5!=0)) || ((bgl6 <2.5)&&(bgl6!=0)) || ((bgl7 <2.5)&&(bgl7!=0)) || ((bgl8 <2.5)&&(bgl8!=0)) || ((bgl9 <2.5)&&(bgl9!=0)) || ((bgl10 <2.5)&&(bgl10!=0)) || ((bgl11 <2.5)&&(bgl11!=0))) {
                        ...
                        Toast.makeText(IVFluids12Activity.this, "Reocrd Saved.", Toast.LENGTH_LONG).show();
                        progressDialog.dismiss();
                    }
                }
                else {
                    String msg = task.getException().getMessage();
                    Toast.makeText(IVFluids12Activity.this, "Error Occured: " + msg , Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
            }
        });
    ...
    public void showFluidDialog() {
        Toast.makeText(IVFluids12Activity.this, "Baby is still in Hypoglycemia", Toast.LENGTH_SHORT).show();
        AlertDialog.Builder builder_fluid = new AlertDialog.Builder(IVFluids12Activity.this);
        float fluid_amount;
        int x = 0;
        ...
        TextView textViewTitle = new TextView(IVFluids12Activity.this);
        textViewTitle.setPadding(20,10,20,10);
        textViewTitle.setTypeface(null, Typeface.BOLD);
        textViewTitle.setTextSize(20);
        textViewTitle.setTextColor(Color.BLACK);
        textViewTitle.setText("Please proceed the IV Fluids treatment with " + fluid_needed + "mls/kg with 15% dextrose and monitor blood glucose level every 3 hours in 24 hours");
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mBaby.child(babyName).updateChildren(babyMap).addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful())
                        {
                            Intent i = new Intent (IVFluids12Activity.this, IVFluids15Activity.class);
